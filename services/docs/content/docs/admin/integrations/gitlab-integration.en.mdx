...
description: Configure GitLab providers, link projects to apps, and review synchronized changes.
---

> **Note:** Repository sync now supports both GitLab and GitHub (including GitHub Enterprise). See [Repository sync](/admin/integrations/repository-sync) for the provider-neutral workflow. This page keeps GitLab-specific terminology and legacy examples for existing installations.
...
In the JustApps admin UI ([Repository providers](/verwaltung/integrationen/repository-providers)):

---
title: Contributing
description: Set up a development environment and contribute changes to JustApps.
---
...
See [First installation and bootstrap](/admin/getting-started) for full setup instructions.

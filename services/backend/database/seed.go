	...
	apps := []models.Apps{
		{
			...
			Repositories: []models.AppLink{
				{Label: "Frontend", URL: "https://github.com/bund/digi-sign-pro-frontend"},
				{Label: "Backend", URL: "https://github.com/bund/digi-sign-pro-backend"},
			},
			CustomLinks: []models.AppLink{
				{Label: "Produktseite", URL: "https://digisign-pro.bund.de"},
			},
			CustomFields: []models.AppField{
				{Key: "focus",          Value: "Digitale Signatur / Workflows"},
				{Key: "app_type",       Value: "Fullstack Webanwendung"},
				{Key: "use_case",       Value: "Rechtssichere digitale Unterschrift im Verwaltungskontext"},
				{Key: "visualization",  Value: "Dashboard mit Signatur-Status"},
				{Key: "deployment",     Value: "Kubernetes via Helm"},
				{Key: "infrastructure", Value: "On-Premise oder Cloud-agnostisch"},
				{Key: "database",       Value: "Redis für Caching, Signatur-Logs in S3"},
				{Key: "transferability",Value: "Ja, für alle Ressorts mit Signaturbedarf"},
				{Key: "contact_person", Value: "Max Mustermann (BMI)"},
			},
			Status:          "Graduated",
		...
		},
		{
			...
			HelmRepo:    "https://charts.bund.de",
			Repositories: []models.AppLink{
				{Label: "Repository", URL: "https://github.com/bund/open-data-hub"},
			},
		...
		},
		{
			...
			HelmRepo:    "https://charts.bund.de",
			Repositories: []models.AppLink{
				{Label: "Repository", URL: "https://github.com/bund/gov-messenger"},
			},
